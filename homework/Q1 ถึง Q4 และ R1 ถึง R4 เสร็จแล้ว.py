# เขียนแบบมี inheritance กับ polymorph 
# ผู้เรียนได้กำหนดให้ class Ball เป็น class แม่และให้รูปร่างอื่นเป็น class ลูก
# class ลูกจะสืบทอดคุณสมบัติและ method ของ class แม่ทั้งหมดยกเว้น method draw ที่ class ลูกจะใช้ method draw ของตัวเอง (polymorph)
import math
import random
from tkinter import *
